...
public class LevelDB extends AbstractDB {
	...
	/**
	 * <p>
	 * Original constructor for LevelDB, to keep compatibility with tests, for
	 * future use the user should set the {@link #maxOpenFiles} and
	 * {@link #blockSize} directly.
	 * </p>
	 *
	 * <p>
	 * Note: the values set in this constructor are not optimal, only historical.
	 * </p>
	 */
	@Deprecated
