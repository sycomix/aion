...
public class DatabaseWithCache implements IByteArrayKeyValueDatabase {
    ...
    public long deleteAllExcept(IByteArrayKeyValueStore db) {
        // TODO: reconsider functionality in terms of caching and non automatic commits
        check();

        this.loadingCache.invalidateAll();
        this.dirtyEntries.clear();
        return this.database.deleteAllExcept(db);
    }
    ...
    public long deleteAllExcept(IByteArrayKeyValueStore db, long limit) {
        ...
        this.loadingCache.invalidateAll();
        this.dirtyEntries.clear();
        return this.database.deleteAllExcept(db, limit);
    }
}
