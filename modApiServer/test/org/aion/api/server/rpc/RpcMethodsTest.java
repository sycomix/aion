...
public class RpcMethodsTest {
    ...
    public void testEmpty() {
        methods = new RpcMethods(AionImpl.inst(), EMPTY, EMPTY, EMPTY);
    ...
    public void testGroupsOnly() {
        ...
        methods = new RpcMethods(AionImpl.inst(),enabledGroups, EMPTY, EMPTY);
    ...
    public void testEnableMethods() {
        ...
        methods = new RpcMethods(AionImpl.inst(),EMPTY, enabledMethods, EMPTY);
    ...
    public void testDisableMethods() {
        ...
        methods = new RpcMethods(AionImpl.inst(),enabledGroups, EMPTY, disabledMethods);
    ...
    public void testDisablePing() {
        ...
        methods = new RpcMethods(AionImpl.inst(),EMPTY, EMPTY, disabledMethods);
