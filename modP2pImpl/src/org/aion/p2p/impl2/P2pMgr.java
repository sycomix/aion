...
public final class P2pMgr implements IP2pMgr {
    ...
    /**
     * Will drop an active node (if possible) TODO: verify that this indeed does
    ...
    public void run() {
        try {
            ...
            // this is the main selector thread, this thread handles the
            // following tasks:
            // 1) All selector registration is done through this channel,
            // selector
            // registration
            ...
            // TaskPersistNodes(nodeMgr), 30000,
    ...
    private final class HandleChannel implements Task {
        ...
        public void channelReady(SelectableChannel channel, SelectionKey key) {
            try {
                ...
                // on any IO exception, cancel the channel, no need to close it
                // should be
